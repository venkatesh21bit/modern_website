...
const Hero = () => {
  ...
  const handleVideoError = () => {
    // Increment loaded count to avoid indefinite loading state
    setLoadedVideo((prev) => prev + 1);
  };

  const previousVideoIndex = ((currentIndex - 1) % totalVideo) + 1;
  ...
  useEffect(() => {
    // Hide the loader when all videos are loaded
